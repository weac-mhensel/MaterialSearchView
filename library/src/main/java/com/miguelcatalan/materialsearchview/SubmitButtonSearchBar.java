...
/**
 * Verson of MaterialSearchView with submit buton
 */
public class SubmitButtonSearchBar extends FrameLayout implements Filter.FilterListener {
    ...
    public SubmitButtonSearchBar(Context context) {
        this(context, null);
    }

    public SubmitButtonSearchBar(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SubmitButtonSearchBar(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs);
    ...
    private void initStyle(AttributeSet attrs, int defStyleAttr) {
        ...
        if (a != null) {
            ...
            if (a.hasValue(R.styleable.SubmitButtonSearchBar_searchSubmitIcon)) {
                setSubmitIcon(a.getDrawable(R.styleable.SubmitButtonSearchBar_searchSubmitIcon));
            }

            if (a.hasValue(R.styleable.SubmitButtonSearchBar_showSubmitButton)) {
                mSubmitBtn.setVisibility(
                        a.getBoolean(R.styleable.SubmitButtonSearchBar_showSubmitButton, false)?
    ...
    private void initiateView() {
        LayoutInflater.from(mContext).inflate(R.layout.submit_search_view, this, true);
    ...
    private void initSearchView() {
        ...
        mSearchSrcTextView.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                mUserQuery = s;
                startFilter(s);
                SubmitButtonSearchBar.this.onTextChanged(s);
            }
    ...
    private void startFilter(CharSequence s) {
        if (mAdapter != null && mAdapter instanceof Filterable) {
            ((Filterable) mAdapter).getFilter().filter(s, SubmitButtonSearchBar.this);
        }
    }
    ...
    private final OnClickListener mOnClickListener = new OnClickListener() {
        ...
        public void onClick(View v) {
            if (v == mBackBtn) {
                ...
                onSubmitQuery();
                hideKeyboard(SubmitButtonSearchBar.this);
    ...
    public void setSubmitIcon(Drawable drawable) {
    ...
    public void setCursorDrawable(int drawable) {
        try {
            ...
            Log.e("SubmitButtonSearchBar", ignored.toString());
        }
    }
     ...
     * @param listener
     */
    public void setOnQueryTextListener(com.miguelcatalan.materialsearchview.MaterialSearchView.OnQueryTextListener listener) {
     ...
     * @param listener
     */
    public void setOnSearchViewListener(com.miguelcatalan.materialsearchview.MaterialSearchView.SearchViewListener listener) {
